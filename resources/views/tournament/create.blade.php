...
<div class="container">
    <form method="post" action="{{ action('TournamentController@store') }}">
        ...
        <div class="form-group">
            ...
            <input type="name" class="form-control" id="name" name="name" placeholder="Vul hier een naam in" required>
        </div>

        <div class="form-group">
            <label for="description">Beschrijving *</label>
            <input type="description" class="form-control" id="description" name="description"
                placeholder="Vul hier een beschrijving in" required>
        </div>

        <div class="form-group">
            <label for="start-date-time">Start datum en tijd *</label>
            <input class="form-control" type="datetime-local" id="start-date-time" max="2100-12-31T00:00" name="start-date-time" required>
        </div>
