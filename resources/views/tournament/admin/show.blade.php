        ...
        <tr>
            ...
            <td>
                ...
                <form action="{{ action('TournamentAdminController@deleteUser', [
                    ...
                    @method('DELETE')
                    @csrf()
                    <button type="submit" class="btn btn-link text-danger" style="width: max-content;">Verwijder beheerder</button>
                </form>
                @else
                <form action="{{ action('TournamentAdminController@storeUser', [
                    ...
                    @csrf()
                    <button type="submit" class="btn btn-link text-success" style="width: max-content;">Maak beheerder</button>
                </form>
                @endif
            </td>
            <td>
                ...
                <form action="{{ action('TournamentAdminController@deleteUser', [
                    ...
                    @method('DELETE')
                    @csrf()
                    <button type="submit" class="btn btn-link text-danger" style="width: max-content;">Verwijder deelnemer</button>
                </form>
                @else
                <form action="{{ action('TournamentAdminController@storeUser', [
                            'tournamentId' => $tournament->id,
                    ...
                    @csrf()
                    <button type="submit" class="btn btn-link text-success" style="width: max-content;">Maak deelnemer</button>
                </form>
                @endif
            </td>
        </tr>
